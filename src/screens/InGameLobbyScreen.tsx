...
export function InGameLobbyScreen({ navigation, route }: Props) {
  ...
  const orderedRoster = [...roster].sort((a, b) => (a.isHost === b.isHost ? 0 : a.isHost ? -1 : 1));
  const displayCode = matchCode ? `GK-${matchCode}` : '';
    ...
    <View style={styles.page}>
      ...
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
          {loading ? <Text style={styles.loadingText}>Loading lobby…</Text> : null}

          <View style={styles.playersHeaderRow}>
            <Text style={styles.sectionLabel}>Players · {orderedRoster.length}</Text>
          ...
          <View style={styles.playerList}>
            {orderedRoster.map((player, index) => {
              ...
              return (
                <View key={player.playerId} style={[styles.playerRow, isViewer ? styles.playerRowViewer : styles.playerRowDefault]}>
                  ...
                  <View style={styles.playerInfo}>
                    ...
                    <Text style={styles.playerMeta}>
                      {player.handicap !== null ? `HCP ${player.handicap}` : 'No handicap yet'} · joined
                    </Text>
                  </View>
          ...
          <View style={styles.tipCard}>
            ...
            <Text style={styles.tipText}>
              ...
              {!isHostViewer ? '\nOnly the host can adjust strokes once the round is underway.' : ''}
            </Text>
          </View>
          ...
          <View style={styles.stakesCard}>
            ...
            <Text style={styles.stakesValue}>${stakePerHole}</Text>
          </View>
        </ScrollView>
